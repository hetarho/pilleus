...
export const designToken = pgTable("design_token", {
  ...
  /** Usage guidance — when to reach for this token vs. a sibling. Set by
   * the author or generated by the AI token-generation task. Nullable
   * because legacy tokens predate this column. */
  description: text("description"),
  createdAt: timestamp("created_at").notNull().defaultNow(),
  updatedAt: timestamp("updated_at").notNull().defaultNow(),
});
